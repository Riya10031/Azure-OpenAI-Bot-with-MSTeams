...
1. Navigate to the **notebooks** folder, select **flask-app-local-test.ipynb (1)** file and select the kernal as **Python 3.10-AzureML (2)**.

   ![](<Images/bots-ex2-t2-s1(1).png>)
...
1. Navigate to the path **/home/azureuser/cloudfiles/code/Users/odl*user*<inject key="DeploymentID" enableCopy="false"/>/artifacts/openai-model/ (1)** and click on **Ok (2)**.
...
1. Navigate to the **notebooks** folder, select **flask-app-service-test.ipynb (1)** file and select the kernal as **Python 3.10-AzureML (2)**.
