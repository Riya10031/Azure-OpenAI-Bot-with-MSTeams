...
1. On the Select a model pop-up, Select **gpt-35-turbo-instruct (1)** and click on **Confirm(2)**.
   ...
   ![](<Images/model05(1).png>)

1. On the Deploy model gpt-35-turbo-instruct pop-up , enter the deployment name as **davinci003 (1)**,from Model Version drop-down select **0914** and scale down the **Tokens per Minute Rate Limit (thousands) (2)** to **10k** then click on **Deploy (3)**.
